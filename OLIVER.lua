...
SUDO = SUDO
sudo_users = {SUDO,472424473,472424473}   
print([[
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/OLIVRTEAM/FIlES_OLIVER/main/File_Bot/commands.lua") 
t = "\27[35m".."\nAll Files Started : \n-----------------------------------\n"..'\27[m'
i = 0
...
if hash or SudoBot(msg) or DevOLIVERW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevOLIVERW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevOLIVERW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevOLIVERW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevOLIVERW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevOLIVERW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevOLIVERW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(472424473) then  
var = true  
elseif tonumber(user_id) == tonumber(472424473) then
var = true  
...
local UserName = (data.username_ or "OLIVER")
...
local OLIVER_Msg = ''  
if msgs < 100 then 
OLIVER_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
OLIVER_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
OLIVER_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
OLIVER_Msg = 'متفاعل' 
elseif msgs < 1200 then 
OLIVER_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
OLIVER_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
OLIVER_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
OLIVER_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
OLIVER_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
OLIVER_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
OLIVER_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
OLIVER_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
OLIVER_Msg = 'رب التفاعل'  
end 
return OLIVER_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@iz_56")  
...
--------------------------------------------------------------------------------------------------------------
function SourceOLIVER(msg,data) -- بداية العمل   
if msg then
...
Namot = (database:get(bot_id..'Name:Bot') or 'اوليفر')
SourceOLIVERr = '※︙مرحبا بك عزيزي 👋🏼،\n※︙انا بوت حمايه المجموعات  ؟\n※︙يمكنك اضافتي الى مجموعتك •\n※︙آضفني وارفعني مشرف ارسل < تفعيل >\n[ᴄʜ › ᴏʟɪᴠᴇʀᴛᴇᴀᴍ 𝄮](t.me/P6669)'
end
send(msg.chat_id_, msg.id_, SourceOLIVERr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevOLIVERW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevOLIVERW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,OLIVER_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ※' and DevOLIVERW(msg) then  
...
if text == 'تعطيل التواصل ※' and DevOLIVERW(msg) then  
...
if text == 'تفعيل البوت الخدمي ※' and DevOLIVERW(msg) then  
...
if text == 'تعطيل البوت الخدمي ※' and DevOLIVERW(msg) then  
...
if text == 'ضع كليشه ستارت ※' and DevOLIVERW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *※︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ※' and DevOLIVERW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *※︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ※' and DevOLIVERW(msg) then 
...
if text == 'تحديث السورس ※' and DevOLIVERW(msg) then 
os.execute('rm -rf OLIVER.lua')
os.execute('wget https://raw.githubusercontent.com/OLIVRTEAM/OLIVER/main/OLIVER.lua')
send(msg.chat_id_, msg.id_,' *※︙تم تحديث السورس* \n*※︙لديك اخر اصدار لسورس اوليفر*\n*※︙الاصدار » { 2.9v}*')
dofile('OLIVER.lua')  
end
if text == 'الاصدار ※' and DevOLIVERW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *※︙اصدار سورس اوليفر* \n*※︙الاصدار »{ 2.9v}*')
end
if text == 'قناه تحديثات البوت ※' and DevOLIVERW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ※︙[تحديثات البوت](t.me/P6669) \n※︙[قناه السورس](t.me/P6669)')
end
if text == "ضع اسم للبوت ※" and DevOLIVERW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *※︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ※' and DevOLIVERW(msg) then 
...
if text == 'المشتركين ※' and DevOLIVERW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *※︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ※' and DevOLIVERW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *※︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ※") and DevOLIVERW(msg) then
...
if text == ("قائمه العام ※") and DevOLIVERW(msg) then
...
if text == ("قائمه الكتم العام ※") and DevOLIVERW(msg) then
...
if text=="اذاعه خاص ※" and msg.reply_to_message_id_ == 0 and DevOLIVERW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *※︙ارسل الان اذاعتك؟* \n*※︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ※" and msg.reply_to_message_id_ == 0 and DevOLIVERW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *※︙ارسل الان اذاعتك؟* \n*※︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ※" and msg.reply_to_message_id_ == 0 and DevOLIVERW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *※︙ارسل الان اذاعتك؟* \n*※︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ※" and msg.reply_to_message_id_ == 0  and DevOLIVERW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *※︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ※" and msg.reply_to_message_id_ == 0  and DevOLIVERW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ※︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ※' and DevOLIVERW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ※" and DevOLIVERW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ※" and DevOLIVERW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*※︙عدد الكروبات الان » { '..#group..' }'..OLIVERk..''..OLIVER..'*\n*※︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevOLIVERW(msg) then
...
usertext = '*\n ※︙العضو »* ['..result.title_..'](t.me/'..(username or 'OLIVER')..')'
status  = '\n *※︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevOLIVERW(msg) then
...
usertext = '\n *※︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'OLIVER')..')'
status  = '\n*※︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevOLIVERW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevOLIVERW(msg) then
...
local OLIVER1_Msg = database:get(bot_id.."OLIVER1:Add:Filter:Rp2"..text..msg.chat_id_)   
if OLIVER1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *※︙العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'OLIVER')..') \n ※︙'..OLIVER1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if OLIVER_Msg and not Special(msg) then  
local OLIVER_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if OLIVER_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *※︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n※︙["..OLIVER_Msg.."] \n")
else
send(msg.chat_id_,0," *※︙العضو :* {["..data.first_name_.."](t.me/P6669)}\n※︙["..OLIVER_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *※︙عذرا »* {["..data.first_name_.."](t.me/P6669)}\n*※︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})   
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevOLIVERW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevOLIVERW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevOLIVERW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *※︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevOLIVERW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *※︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ※" and DevOLIVERW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *※︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ※$") and DevOLIVERW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *※︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ※" and DevOLIVERW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ※" and DevOLIVERW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *※︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ※" and DevOLIVERW(msg) then  
...
{{text = 'ᴄʜ › ᴏʟɪᴠᴇʀᴛᴇᴀᴍ 𝄮.',url="t.me/P6669"}},
}
...
send(msg.chat_id_,msg.id_,'※︙شترك في قناة السورس اولآ @P6669 .')
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ᴏʟɪᴠᴇʀᴛ\n\n[※  ᴄʜᴀɴɴᴇʟ ᴏʟɪᴠᴇʀᴛ](http://t.me/P6669)\n\n[※  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/r666l)\n\n[※  ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/iz_56)\n\n[※  ʙᴏᴛ ᴏʟɪᴠᴇʀᴛ](http://t.me/P666bot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '※ sᴏᴜʀᴄʀ ᴏʟɪᴠᴇʀᴛ',url="t.me/P6669/157"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. P6669&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))msg.chat_id_ .. '&photo=https://t.me/
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevOLIVERW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *※︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'OLIVER')..') \n*※︙تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *※︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'OLIVER')..') \n*※︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ 
if text == 'تحديث' and DevOLIVERW(msg) then
dofile('OLIVER.lua')  
send(msg.chat_id_, msg.id_, ' *※︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevOLIVERW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevOLIVERW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
function start_function(extra, result, success)
if OLIVERSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevOLIVERW(msg) then
...
if OLIVERSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*※︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevOLIVERW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevOLIVERW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevOLIVERW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevOLIVERW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevOLIVERW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevOLIVERW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevOLIVERW(msg) then
...
------------------------------------------------------------------------ 
if text == ("مسح المطورين") and DevOLIVERW(msg) then
...
if text == 'الملفات' and DevOLIVERW(msg) then
t = ' *※︙ملفات السورس اوليفر ↓*\n*------------------------------------------------* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevOLIVERW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/OLIVRTEAM/FIlES_OLIVER/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *※︙اهلا بك في متجر ملفات اوليفر*\n*※︙ملفات السورس ↓*\n*------------------------------------------------*\n\n"
local TextE = "\n*------------------------------------------------*\n *※︙علامة تعني { ✓ } ملف مفعل*\n *※︙علامة تعني { ✘ } ملف معطل*\n *※︙قناة سورس اوليفر ↓*\n".." *※︙*[اضغط هنا لدخول](t.me/P6669) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevOLIVERW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/OLIVRTEAM/FIlES_OLIVER/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevOLIVERW(msg) then
...
if text == "مسح الملفات" and DevOLIVERW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *※︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevOLIVERW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevOLIVERW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "OLIVER")
...
function Function_OLIVER(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_OLIVER, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_OLIVER, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *※︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'OLIVER')..')'
status  = '\n*※︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *※︙العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *※︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'OLIVER')..')'
...
database:set(bot_id.."OLIVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end
if text then   
local tsssst = database:get(bot_id.."OLIVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *※︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."OLIVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."OLIVER1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."OLIVER1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."OLIVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *※︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."OLIVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."OLIVER1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."OLIVER1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."OLIVER1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then
send(msg.chat_id_, msg.id_," *※︙ارسل الكلمه الان*")  
database:set(bot_id.."OLIVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."OLIVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."OLIVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."OLIVER1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."OLIVER1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."OLIVER1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."OLIVER1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."OLIVER1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."OLIVER1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n *※︙قائمة المنع* \n*-----------------------------------*\n"
for k,v in pairs(list) do  
local OLIVER_Msg = database:get(bot_id.."OLIVER1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..OLIVER_Msg.."}\n"
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevOLIVERW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *※︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevOLIVERW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *※︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'OLIVER')..')'..'\n*※︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevOLIVERW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevOLIVERW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..OLIVER_Msg[math.random(#OLIVER_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevOLIVERW(msg) then 
...
if OLIVERSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevOLIVERW(msg) then 
...
if text == ("ردود المطور") and DevOLIVERW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ※︙قائمة ردود المطور \n*-----------------------------------*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevOLIVERW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevOLIVERW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevOLIVERW(msg) then   
...
if text == 'تعطيل المغادره' and DevOLIVERW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'OLIVER')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
OLIVERdx(msg.chat_id_, msg.id_, ' *※︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*※︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*※︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*※︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevOLIVERW(msg) then
...
if text == 'تعطيل الالعاب الاحترافيه' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
  ...
  {{text = 'ᴏʟɪᴠᴇʀᴛ ᴛᴇᴀᴍ', url="t.me/P6669"}},
  {{text = 'مطور السورس', url="t.me/iz_56"}},
  }iz_56
...
if text == "كت تويت" or text == "كت اتويت" or text == "كت" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
OLIVER = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(OLIVER)
...
--------------------------------------------------------------------------------------------------------------
SourceOLIVER(data.message_,data)
...
------------------------------------------------------------------------
local OLIVERAbot = database:get(bot_id.."OLIVER1:Add:Filter:Rp2"..text..result.chat_id_)   
if OLIVERAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *※︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n※︙["..OLIVERAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local OLIVER1_Msg = database:get(bot_id.."OLIVER1:Add:Filter:Rp2"..text..result.chat_id_)   
if OLIVER1_Msg then
send(msg.chat_id_, msg.id_," ※︙"..OLIVER1_Msg)
